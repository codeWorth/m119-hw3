...
#define BLE_UUID_UP_X "2104"
#define BLE_UUID_UP_Y "2105"
#define BLE_UUID_UP_Z "2106"
...
BLEFloatCharacteristic upX(BLE_UUID_UP_X, BLERead | BLENotify);
BLEFloatCharacteristic upY(BLE_UUID_UP_Y, BLERead | BLENotify);
BLEFloatCharacteristic upZ(BLE_UUID_UP_Z, BLERead | BLENotify);
...
void setup() {
  ...
  accelerometerService.addCharacteristic(forwardX);
  accelerometerService.addCharacteristic(forwardY);
  accelerometerService.addCharacteristic(forwardZ);
  accelerometerService.addCharacteristic(upX);
  accelerometerService.addCharacteristic(upY);
  accelerometerService.addCharacteristic(upZ);
  ...
  if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
    ...
    if (g_av_count < 500) {
      ...
      if (central) {        
        ...
        Matrix<3> up = IMU_BASIS.Submatrix<3, 1>(0, 2);
